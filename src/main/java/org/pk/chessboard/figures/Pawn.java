...
public class Pawn extends Figure implements Moves {
    ...
    public Pawn(double width, double height, String figureType) {
        ...
        if (figureType.equals("P")) {
            this.figureLabel.setGraphic(new ImageView(new Image(String.valueOf(Field.class.getResource("assets/WPawn.png")))));
        }
        else {
            this.figureLabel.setGraphic(new ImageView(new Image(String.valueOf(Field.class.getResource("assets/BPawn.png")))));
        }
    }
