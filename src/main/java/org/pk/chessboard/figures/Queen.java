...
public class Queen extends Figure implements Moves {
    ...
    public Queen(double width, double height, String figureType) {
        ...
        if (figureType.equals("Q")) {
            this.figureLabel.setGraphic(new ImageView(new Image(String.valueOf(Field.class.getResource("assets/WQueen.png")))));
        }
        else {
            this.figureLabel.setGraphic(new ImageView(new Image(String.valueOf(Field.class.getResource("assets/BQueen.png")))));
        }
    }
